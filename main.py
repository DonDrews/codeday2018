'''
Authors: Alex Tyler, Donovan Drews

Description: This script allows users to input what they would to stream on twitter and how many tweets they would like
on the topic. Then it takes a predetermined list of words and filters all of the tweets into a list with these wordsself.
Following that, it then uses a word cloud library to draw them into a world cloud for later analysis and disply.
'''
